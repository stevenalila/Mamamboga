...
const routes: Routes = [
    ...
    { path: 'productses/:id',  loadChildren: './pages/products-edit/products-edit.module#ProductsEditModule' , canActivate: [AuthGuard] },
    { path: 'productses',  loadChildren: './pages/products-list/products-list.module#ProductsListModule' , canActivate: [AuthGuard] },
